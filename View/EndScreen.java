...
public class EndScreen extends JFrame {
    ...
    public EndScreen(Display display) {
        ...
        JLabel moneyLabel = new JLabel("You have " + money + " €");
        moneyLabel.setFont(new Font("Arial", Font.BOLD, 30));
        moneyLabel.setBounds(END_W / 2 - 150, END_H / 2 - 50, 300, 50);
        ...
        if (money >= GOAL) {
            ...
            winLabel.setBounds(END_W / 2 - 150, END_H / 2 + 50, 300, 50);
            ...
            loseLabel.setBounds(END_W / 2 - 250, END_H / 2 + 50, 500, 50);
